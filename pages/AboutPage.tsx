...
const AboutPage: React.FC = () => {
  return (
    <div className="py-12">
      ...
      <div className="bg-white/20 backdrop-blur-md rounded-lg p-8 shadow-lg mb-12">
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {skills.map((skill) => (
            <div key={skill.id} className="group relative overflow-hidden rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
              ...
              <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
               ...
               <h3 className="absolute bottom-4 left-4 text-2xl font-bold text-white">{skill.name}</h3>
            </div>
          ))}
        </div>
      </div>
