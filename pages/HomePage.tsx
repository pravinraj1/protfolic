...
const HomePage: React.FC = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center md:justify-around min-h-full gap-8 py-10">
      <div className="md:w-1/2 text-center md:text-left order-2 md:order-1 animate-fade-in-up">
        ...
        <p className="max-w-xl mx-auto md:mx-0 text-slate-600 leading-relaxed mb-8">
        ...
        <a 
          href="#/projects" 
          className="inline-block bg-[#F4F754] text-slate-900 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105"
        >
          View My Work
        </a>
      </div>
